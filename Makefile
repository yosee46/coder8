...
srcdir = ./vendor/bundle/ruby/1.9.1/gems/mysql-2.9.1/ext/mysql_api
topdir = /Users/A12645/.rvm/rubies/ruby-1.9.3-p392/include/ruby-1.9.1
hdrdir = /Users/A12645/.rvm/rubies/ruby-1.9.3-p392/include/ruby-1.9.1
arch_hdrdir = /Users/A12645/.rvm/rubies/ruby-1.9.3-p392/include/ruby-1.9.1/$(arch)
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Users/A12645/.rvm/rubies/ruby-1.9.3-p392
...
DEFS     = 
CPPFLAGS = -DHAVE_MYSQL_SSL_SET -DHAVE_RB_STR_SET_LEN -DHAVE_MYSQL_H -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE $(DEFS) $(cppflags) -I/usr/local/opt/libyaml/include -I/usr/local/opt/readline/include -I/usr/local/opt/libxml2/include -I/usr/local/opt/libxslt/include -I/usr/local/opt/libksba/include -I/usr/local/opt/openssl/include -I/usr/local/opt/sqlite/include -I/usr/local/Cellar/mysql/5.6.10/include  -Os -g -fno-strict-aliasing
...
sitearch = $(arch)
ruby_version = 1.9.1
ruby = /Users/A12645/.rvm/rubies/ruby-1.9.3-p392/bin/ruby
RUBY = $(ruby)
RM = rm -f
...
target_prefix = /mysql
LOCAL_LIBS = 
LIBS = $(LIBRUBYARG_SHARED) -L/usr/local/Cellar/mysql/5.6.10/lib -lmysqlclient  -lpthread -ldl -lobjc 
SRCS = mysql.c
OBJS = mysql.o
TARGET = mysql_api
DLLIB = $(TARGET).bundle
...
pre-install-rb-default:
	$(ECHO) installing default mysql_api libraries
./.RUBYARCHDIR.time:
...
$(DLLIB): $(OBJS) Makefile
	$(ECHO) linking shared-object mysql/$(DLLIB)
	-$(Q)$(RM) $(@)
